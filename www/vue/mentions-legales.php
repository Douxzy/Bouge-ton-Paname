...
<div class="max-w-4xl mx-auto px-6 py-12">
        ...
        <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-700 mb-2">Éditeur du site</h2>
            <p>
        ...
        <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-700 mb-2">Responsable de la publication</h2>
            <p>Romain Deschaseaux</p>
        </section>
        ...
        <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-700 mb-2">Propriété intellectuelle</h2>
            <p>
